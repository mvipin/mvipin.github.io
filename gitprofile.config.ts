...
const CONFIG = {
      ...
      projects: [
        {
          ...
          description:
            'Engineered real-to-sim VLA pipeline in Isaac Sim with dual-camera vision (wrist + front), USD-based ingredient physics, and automatic subtask detection via gripper-object proximity monitoring; MimicGen 10x augmentation reduced human demonstrations by 80% while eliminating manual annotation overhead. Conducted 103-trial structured evaluation across 35 test conditions; demonstrated 77.8% language invariance and 75% spatial robustness, with 37.7% end-to-end success on primary manipulation tasks. Characterized VLA failure modes: object discrimination bias, and semantic-action gap where VLM understanding does not consistently drive action decisions. Tech Stack: Python | GR00T N1.5 VLA • Eagle VLM (SigLIP-2 + Qwen3) • Diffusion Transformer • LoRA • MimicGen • LeRobot | OpenCV | SO-101 Arm • STS3215 Servos • USB Cam | Isaac Sim/Lab',
          imageUrl:
  ...
  resume: {
    fileUrl:
      'https://docs.google.com/document/d/19iBAYpp-WJgVmCmylz6P22CFCuURBS8spWjtTTH5vGs/export?format=pdf',
  },
  skills: [
  ...
  googleAnalytics: {
    id: 'G-6CPWHJTS2Y', // GA4 Measurement ID
  },
